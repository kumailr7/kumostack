...
def test_module_cold_import_with_typical_snapshot_does_not_log_restore_failure(
    ...
    # the prior import.
    import kumostack.services as _services_pkg

    full_name = f"kumostack.services.{mod_name}"
    # The cold-import swaps a brand-new module object into BOTH sys.modules and
    # the `kumostack.services` package attribute. Other already-imported modules
    # that did `from kumostack.services import <mod>` keep a reference to the
    ...
    # package attribute must be restored: `from kumostack.services import <mod>`
