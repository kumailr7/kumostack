...
Issue: https://github.com/kumostackorg/kumostack/issues/389
...
_patched_post_init._kumostack_patched = True  # type: ignore[attr-defined]


def install() -> None:
    """Install the reason-phrase patch. Idempotent."""
    if getattr(h11.InformationalResponse.__post_init__, "_kumostack_patched", False):
        return
