...
Real EC2 binds 169.254.169.254 at the hypervisor; in kumostack we expose
...
from kumostack.services.iam import (
    _future,
    _gen_secret,
...
_DEFAULT_ROLE = "kumostack-instance-role"
...
def _ecs_task_credentials_doc() -> dict:
    ...
    return {
        ...
        "Token": _gen_session_token(),
        "Expiration": _future(3600),
        "RoleArn": f"arn:aws:iam::{get_account_id()}:role/kumostack-ecs-task-role",
    }
...
_META_FLAT: dict[str, str] = {
    "ami-id": "ami-kumostack",
    "ami-launch-index": "0",
    "ami-manifest-path": "(unknown)",
    "hostname": "kumostack.local",
    "instance-action": "none",
    "instance-life-cycle": "on-demand",
    "instance-type": "t3.micro",
    "local-hostname": "kumostack.local",
    "local-ipv4": "127.0.0.1",
    "mac": "02:00:00:00:00:00",
    "profile": "default-hvm",
    "public-hostname": "kumostack.local",
...
async def handle_request(method, path, headers, body, query_params):
    ...
    if path == "/latest/dynamic/instance-identity/pkcs7" or \
        ...
        return _text("kumostack-unsigned")
