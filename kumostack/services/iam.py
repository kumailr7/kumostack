...
from kumostack.core.responses import AccountScopedDict, get_account_id, get_region, json_response, new_uuid
...
# them regardless of their own account. KumoStack stores customer
...
def _autovivify_aws_managed_policy(arn: str) -> dict:
    ...
    record = _make_aws_managed_record(name, doc, description=f"AWS-managed policy {name} (autocreated by KumoStack).")
