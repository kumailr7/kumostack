...
import kumostack.services.acm as _acm
...
import kumostack.services.cloudfront as _cf
import kumostack.services.cloudwatch as _cw
import kumostack.services.cloudwatch_logs as _cw_logs
import kumostack.services.codebuild as _codebuild
import kumostack.services.cognito as _cognito
import kumostack.services.dynamodb as _dynamodb
import kumostack.services.ec2 as _ec2
import kumostack.services.ecr as _ecr
...
import kumostack.services.ssm as _ssm
import kumostack.services.stepfunctions as _sfn
import kumostack.services.waf as _waf
from kumostack.core.responses import get_account_id, get_region, new_uuid, now_iso
...
def _scheduler_schedule_create(logical_id, props, stack_name):
    import kumostack.services.scheduler as _sched
    name = props.get("Name") or _physical_name(stack_name, logical_id, max_len=64)
...
def _eks_cluster_create(logical_id, props, stack_name):
    import kumostack.services.eks as _eks
...
def _custom_resource_create(logical_id, props, stack_name, resource_type="AWS::CloudFormation::CustomResource"):
    from kumostack.services.cloudformation import custom_resource as _cr
...
def _sfn_state_machine_create(logical_id, props, stack_name):
    ...
    if props.get("DefinitionS3Location"):
        ...
        if bucket and key:
            from kumostack.services import s3 as _s3_svc
            try:
