...
stream records directly from kumostack.services.dynamodb (single synthetic
...
from kumostack.core.responses import error_response_json, get_account_id, get_region, json_response
from kumostack.services import dynamodb as _ddb

logger = logging.getLogger("dynamodb_streams")

# Single synthetic shard per stream — KumoStack does not model shard splitting.
...
def _list_streams(data):
    ...
    ``LastEvaluatedStreamArn``. KumoStack deployments have a small number of
